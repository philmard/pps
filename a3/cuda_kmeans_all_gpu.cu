...
/*                          
                          TODO: If you choose to d0o (some of) the new centroid calculation here, you will need some extra parameters here (from "update_centroids").
*/				
  ...
  /* TODO: copy me from shared version... */
   if (tid<numObjs) {
    ...
    for (i = 1; i < numClusters; i++) {
      /* TODO: call dist = euclid_dist_2_(...) with correct objectId/clusterId using clusters in shmem*/
...
/*	Define the shared memory needed per block.
  ...
  do {
    ...
    const unsigned int update_centroids_dim_sz = ((numCoords*numClusters-1)/update_centroids_block_sz) + 1; /* TODO: calculate dim for "update_centroids" */
